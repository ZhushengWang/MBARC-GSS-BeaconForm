...
namespace SPRL.Test
{
  class E3631A_PS:IPSInterface
  {
    private SerialSession serSession;
    private Object lockObject;

    public E3631A_PS(String sID)
    {
      if (lockObject == null)
      {
    ...
    public void SetV(int nSupply, double dVolts)
    {
      ...
      if (sSupply != "")
      {
        SendCmd("INST " + sSupply +";VOLT "+ dVolts);
      }
    }
    ...
    public void SetI(int nSupply, double dAmps)
    {
      ...
      if (sSupply != "")
      {
        SendCmd("INST " + sSupply + ";CURR " + dAmps);
      }
    }
    ...
    public string GetVSet(int nSupply)
    {
      ...
      string sQuery = "APPLY? " + GetSupplyString(nSupply);
